        ...
        !function (e, t) {
            ...
            n("moxie/core/utils/Basic", [], function () {
                ...
                var i = function (e) {
                    ...
                    var t = {
                        define_property: !1, create_canvas: function () {
                            ...
                            return e.setAttribute("type", "text"), !e.disabled
                        }
                    };
                    return function (i) {
                ...
                return o.OS = o.os, s && (o.debug = {runtime: !0, events: !1}, o.log = function () {
                    var t = arguments[0];
                    if ("string" === e.typeOf(t) && (t = e.sprintf.apply(this, arguments)), window && window.console && window.console.log) window.console.log(t); else if (document) {
                ...
                function a() {
                    ...
                    i.extend(this, {
                        init: function (u) {
                            ...
                            e = u, d = e.accept.mimes || o.extList2mimes(e.accept, g.can("filter_by_extension")), c = g.getShimContainer(), c.innerHTML = '<input id="' + g.uid + '" type="file" accept="image/*" style="font-size:999px;opacity:0;"' + (e.multiple && g.can("select_multiple") ? "multiple" : "") + (e.directory && g.can("select_folder") ? "webkitdirectory directory" : "") + (d ? ' accept="' + d.join(",") + '"' : "") + " />", l = n.get(g.uid), i.extend(l.style, {
                                position: "absolute",
                                top: 0,
                                left: 0,
                                width: "100%",
                        ...
                        if (u) {
                            switch (n.code) {
                                ...
                                case plupload.FILE_SIZE_ERROR:
                                    ...
                                    l = l || i.settings && i.settings.max_file_size, o = "����������ϴ�" + l + "�������ļ���ʹ�������й��ߡ�";
                                    break;
